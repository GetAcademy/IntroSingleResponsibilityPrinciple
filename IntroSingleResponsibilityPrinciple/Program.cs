...
using IntroSingleResponsibilityPrinciple;

Console.Write("Skriv inn filnavn: ");
var filename = Console.ReadLine();
Console.Write("Skriv inn et ord: ");
var word = Console.ReadLine();
var count = CountWordInLinesService.Count(filename, word);
Console.WriteLine(count.GetDescription());

/*
 * 3 kilder til endringer:
 *  - brukergrensesnitt
 *  - lese fra fil
 *  - logikk
 */
